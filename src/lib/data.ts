...
export const HOTELS: Hotel[] = [
  ...
  },
  {
    ...
    tagline: 'Pahadon Ki God Mein Aapka Apna Ghar',
    highlights: ['Scenic Views', 'Peaceful Stay', 'Homely Hospitality', 'Family & Couple Friendly', 'Free Parking', 'Safe & Secure Environment'],
  ...
  },
  {
    ...
    tagline: 'Wake Up to Himalayan Views',
    highlights: ['Scenic Views', 'Premium Stay', 'Peaceful Stay', 'Bonfire on Request', 'Homely Hospitality', 'Free Parking'],
  ...
  },
  {
    ...
    highlights: ['Premium Stay', 'Comfort & Luxury', 'Terrace Rooms', 'Scenic Views', 'Safe & Secure Environment', 'Best Budget Options'],
  ...
  },
  {
    ...
    highlights: ['Scenic Views', 'Premium Stay', 'Comfort & Luxury', 'Terrace Rooms', 'Family & Couple Friendly', 'Free Parking'],
  ...
  },
  {
    ...
    tagline: 'Yaadein Nahi, Anubhav Chuniye',
    highlights: ['Premium Stay', 'Terrace Rooms', 'Scenic Views', 'Homely Food on Request', 'Safe & Secure Environment', 'Special Discounts'],
  ...
  },
  {
    ...
    tagline: 'Yaadein Nahi, Anubhav Chuniye',
    highlights: ['Scenic Views', 'Premium Stay', 'Terrace Rooms', 'Comfort & Luxury', 'Family & Couple Friendly', 'Free Parking'],
  ...
  },
  {
    ...
    tagline: 'Har Yatra Bane Yaadgar, Ghumo Ji Bhar Ke Saath',
    highlights: ['Peaceful Stay', 'Homely Food on Request', 'Safe & Secure Environment', 'Best Budget Options', 'Special Discounts', 'Safe, Reliable & Trusted'],
